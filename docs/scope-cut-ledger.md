...
| 14.2 | Trivy **image** scan (fs + image)                                                           | **done**  | Closed on Day 15: `release.yml` runs `trivy image` (criticals gate) on both signed images by digest before the GitHub Release; Trivy **fs** still gates every PR in `security.yml`.                                                                                                                                                                                                                                                                                                               |
...
conformance) · 14.3 (self-hosted strict bench). 14.2 closed on Day 15 (release image gate). Full future scope: docs/backlog.md.
