        ...
        <section id="sdk" className="scroll-mt-24 px-6 py-20">
          <div className="mx-auto grid max-w-5xl items-start gap-10 md:grid-cols-2">
            <div>
              ...
              <p className="mt-3 text-sm text-muted-foreground md:text-base">
                Your OpenAI client keeps working — <code className="font-mono">@relay/sdk</code> is
                for when you want what the gateway knows about each request as typed fields, and the
                control plane from code. Zero dependencies; Node, Bun, Deno, Workers and browsers.
              </p>
              <ul className="mt-6 space-y-2.5">
                {[
