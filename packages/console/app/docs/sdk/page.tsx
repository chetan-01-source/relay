...
export const metadata: Metadata = {
  ...
  description:
    'relay-gateway-sdk: chat completions with typed Relay metadata, plus a typed control-plane client.',
};
  ...
  return (
    <>
      <DocHeader
        ...
        lede="relay-gateway-sdk is a zero-dependency client for Node 18+, Bun, Deno, Cloudflare Workers and browsers. It exists for the two things a stock OpenAI client cannot do."
      />
      ...
      <DocBody>
        ...
        <DocSection id="install" title="Install">
          <CodeBlock label="shell" code={`npm i relay-gateway-sdk`} />
        </DocSection>

        <DocSection id="chat" title="Chat">
          <CodeBlock
            label="typescript"
            code={`import { Relay } from 'relay-gateway-sdk';
...
const text = await stream.text();`}
        ...
        <DocSection id="errors" title="Errors">
          ...
          <CodeBlock
            label="typescript"
            code={`import { RelayApiError } from 'relay-gateway-sdk';
